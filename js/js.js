...
function Agregar_html_venta ()
{
	...
	if(lastRow){
		...
		//TECNICO
		var td = document.createElement('td');
		td.innerHTML  = "<INPUT type=\"hidden\"  name=\"tecnico_" + num.value + "\" value=\"" + document.getElementById("tecnico").value + "\" >  <span  class=\"textfield01\"><div align=\"center\">" + document.getElementById("tecnico").options[document.getElementById("tecnico").selectedIndex].text +  "</div></span> ";	
		newRow.appendChild(td);

		//CONCEPTO
		var td = document.createElement('td');
		td.innerHTML  = "<INPUT type=\"hidden\"  name=\"concepto_" + num.value + "\" value=\"" + document.getElementById("concepto").value + "\" >  <span  class=\"textfield01\"><div align=\"center\">" + document.getElementById("concepto").value +  "</div></span> ";	
		newRow.appendChild(td);

		//CANTIDAD
		var td = document.createElement('td');
		td.innerHTML  = "<INPUT type=\"hidden\"  name=\"cantidad_" + num.value + "\" value=\"" + document.getElementById("cantidad").value + "\" >  <span  class=\"textfield01\"><div align=\"center\">" + document.getElementById("cantidad").value +  "</div></span> ";	
		newRow.appendChild(td);

		//VALOR UNITARIO
		var td = document.createElement('td');
		td.innerHTML  = "<INPUT type=\"hidden\"  name=\"val_uni_" + num.value + "\" value=\"" + document.getElementById("val_uni").value + "\" >  <span  class=\"textfield01\"><div align=\"center\">" + document.getElementById("val_uni").value +  "</div></span> ";	
		newRow.appendChild(td);


		//VALOR TOTAL
		var td = document.createElement('td');
		td.innerHTML  = "<INPUT type=\"hidden\"  name=\"val_tot_" + num.value + "\" value=\"" + document.getElementById("val_tot").value + "\" >  <span  class=\"textfield01\"><div align=\"center\">" + document.getElementById("val_tot").value +  "</div></span> ";	
		newRow.appendChild(td);
		
		// boton q quita la fila		
		var td = document.createElement('td');
		td.innerHTML = "<div align=\"center\"><INPUT type=\"button\" class=\"botones\" value=\"  -  \" onclick=\"removerFila_venta('" + newRow.id +"','val_inicial','fila_','" + document.getElementById("val_tot").value + "');\"></div>";
		newRow.appendChild(td);
		
		lastRow.parentNode.insertBefore(newRow, lastRow.nextSibling);
		
		document.getElementById("subtotal").value=parseInt(document.getElementById("subtotal").value) + parseInt(document.getElementById("val_tot").value);
		document.getElementById("todocompra").value=parseInt(document.getElementById("todocompra").value) + parseInt(document.getElementById("val_tot").value);
...
function Agregar_html_orden ()
{
	...
	if(lastRow){
		...
		//DESCRIPCION
		var td = document.createElement('td');
		td.innerHTML  = "<INPUT type=\"hidden\"  name=\"observacion_" + num.value + "\" value=\"" + document.getElementById("observacion").value + "\" >  <span  class=\"textfield01\"><div align=\"center\">" + document.getElementById("observacion").value +  "</div></span> ";	
		newRow.appendChild(td);

		//VALOR
		var td = document.createElement('td');
		td.innerHTML  = "<INPUT type=\"hidden\"  name=\"valor_" + num.value + "\" value=\"" + document.getElementById("valor").value + "\" >  <span  class=\"textfield01\"><div align=\"center\">" + document.getElementById("valor").value +  "</div></span> ";	
		newRow.appendChild(td);
		
		// boton q quita la fila		
		var td = document.createElement('td');
		td.innerHTML = "<div align=\"center\"><INPUT type=\"button\" class=\"botones\" value=\"  -  \" onclick=\"removerFila_orden('" + newRow.id +"','val_inicial','fila_');\"></div>";
		newRow.appendChild(td);
...
function removerFila_orden(id,val_inicial,filaName)
{
	//resta total neto  compra
	//document.getElementById("todocompra").value =parseInt(document.getElementById("todocompra").value) - parseInt(total_compra);
	//document.getElementById("subtotal").value =parseInt(document.getElementById("subtotal").value) - parseInt(total_compra);
